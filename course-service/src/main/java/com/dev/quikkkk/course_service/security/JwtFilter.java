package com.dev.quikkkk.course_service.security;

import com.dev.quikkkk.course_service.service.IJwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        log.info("Auth header: {}", request.getHeader(HttpHeaders.AUTHORIZATION));
